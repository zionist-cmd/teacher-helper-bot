...
NORMATIVE_ITEMS: list[KnowledgeItem] = [
    KnowledgeItem(
        ...
        description="Официальные правила аттестации педагогов, присвоения и подтверждения квалификационных категорий.",
        link="https://adilet.zan.kz/rus/docs/V1600013317",
        keywords=("аттестация", "педагог", "квалификационная категория", "портфолио", "оценивание"),
    ),
    KnowledgeItem(
        title="Правила проведения мониторинга образовательных достижений обучающихся",
        description="Нормативная база по мониторингу образовательных достижений обучающихся и сопутствующим процедурам.",
        link="https://adilet.zan.kz/rus/docs/V2100022711",
        keywords=("мониторинг", "образовательные достижения", "обучающиеся", "МОДО", "контроль"),
    ),
    KnowledgeItem(
        title="Перечень республиканских и международных олимпиад и конкурсов",
        description="Актуальный нормативный перечень олимпиад, конкурсов научных проектов, исполнительского мастерства и спортивных соревнований.",
        link="https://adilet.zan.kz/rus/docs/V1100007355",
        keywords=("олимпиада", "конкурс", "научный проект", "соревнование", "одаренные дети"),
    ),
    KnowledgeItem(
        title="Типовые правила текущего контроля, промежуточной и итоговой аттестации обучающихся",
        description="Правила проведения текущего контроля успеваемости и аттестации обучающихся в организациях среднего, ТиПО и послесреднего образования.",
        link="https://adilet.zan.kz/rus/docs/V080005191_",
        keywords=("текущий контроль", "аттестация", "итоговая аттестация", "промежуточная аттестация", "оценивание"),
    ),
    KnowledgeItem(
        title="Перечень документов, обязательных для ведения педагогами, и их формы",
        description="Нормативный перечень обязательной документации педагогов организаций дошкольного, среднего, дополнительного, ТиПО и послесреднего образования.",
        link="https://adilet.zan.kz/rus/docs/V2000020317",
        keywords=("документы педагога", "обязательные документы", "журнал", "план", "отчетность"),
    ),
]
